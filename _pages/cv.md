...
<!--
Schools \& Workshops (participant)
======

2017: 9th Summer Institute in Statistics and Modeling in Infectious Diseases (SISMID), by Department of Biostatistics, University of Washington 

2014: BigDive3: Hacking, Development, Visualization \& Science (third edition)

2014: Complex Networks Thematic School, Les Houches, France

2013: WEHIA-COST PhD School on "Agent-based modeling and policy design for financial crises", Reykjavik, Iceland

2013: Lisbon Machine Learning School (LxMLS), Lisbon, Portugal

2013: Joint CRM-Imperial College School and Workshop in Complex Systems 

2012: FOC-CRISIS School on Complex Financial Networks, IMT Institute for Advanced Studies 

2012: Summer School of Mathematics for Economics and Social Sciences, Centro De Giorgi

2012: Santa Fe Institute Complex Systems Summer School

2011: CIdE Summer School of Econometrics: Panel Data Econometrics and Causal Inference and Program Evaluation 

2010: CIdE XXI Postgraduate Courses on Econometrics
...
<!--* Databases, Tools & APIs: Google BigQuery, MySQL, SQLite, Eclipse, Spyder, Gephi, Twitter API, Facebook API, Quandl API
* C/C++ \& Javascript Libraries: GNU Scientific Library (GSL), D3.js, leaflet.js, sigmajs
* Operating Systems: GNU/Linux, Mac OS X, Microsoft Windows
-->
